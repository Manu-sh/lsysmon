...
#include "private/proc/ProcCpuInfo.hpp"
#include "private/proc/ProcCpuStat.hpp"
#include "private/sysfs/Sysfs.hpp"
...
SingleSocket::Core::Core(uint8_t cpu_n): Freq{cpu_n}, Topology{cpu_n} { /* for slightly better reliability freq. is first */
